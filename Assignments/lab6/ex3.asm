...
#   indicates the end of the array.
	loop:
		lw $10, pixels($9)	#load the number at pixels[i($9)] in $10
		seq $11, $10, -1	#if(pixels[i]==-1) $11
		beq $11, 1, exit	#break
#
...
#
		andi $a2, $10, 0x000000FF 	# Blue ($a2) last two digit $10
		srl  $12, $10, 8		# Move the 3rd and 4th digit to last two $12
		andi $a1, $12, 0x000000FF	# Green ($a1) last two digit $12
		srl  $13, $10, 16		# Move the 5rd and 6th digit to last two $13
		andi $a0, $13, 0x000000FF	# Red ($a0) last two digit $13
...
#   value.
#
		jal rgb_to_gray		#jump to rgb_to_gray
...
#
	add $16, $0, $v0	#put the value of $v0 to $16
...
#
	add $9, $9, 4		#increase the index
	j loop			#go to the next loop
...
#  That's it!
#
	add $14, $a0, $a1	# $14=Red+Green
	add $15, $14, $a2	# $15=$14+Blue
	div $v0, $15, 3		# $v0=$15/3
